...
public class SimpletimerDemoView extends TabbedDemo {
  ...
  private static final String ST_SOURCE =
      "https://github.com/FlowingCode/SimpleTimerAddon/blob/master/src/test/java/com/flowingcode/vaadin/addons/simpletimer/SimpletimerDemo.java";
